...
Intake::Intake(pros::Motor &m_rollers, pros::Motor &m_lever, PneumaticCylinder &m_lifter) : roller_motor(m_rollers), lever_motor(m_lever), lifter(m_lifter) {
...
void Intake::lift_lever() {  
    set_lever = true;
    //lever_motor.move_absolute(-700, 75);
