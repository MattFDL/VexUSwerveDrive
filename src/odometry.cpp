...
public:
    ...
    double position_x = 0;
    double position_y = 0;
    double position_rotation_sensor = 0; //! why dont we just use radians
    ...
    {
        /* #region setup and clculate */
        // calculate turns of wheels
        //!are these ticks calculated for the ticks it takes to make a 360 with the robot
        //? is because we dont have the exact rotation circumfrence of the rotation wheel?
        ...
        // get the arc length of the rotation wheel in turns
