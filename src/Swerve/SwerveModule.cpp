...
class SwerveModule {
    ...
    public:
        ...
        */
        ...
        void set_state(std::pair<double, double> target_state) { //angle in (-180, 180) then velocity in inches
            //TODO angle optimization
            //
            //
            //
            double current_rotation_degs = (static_cast<double>(moduleAngle.get_angle()) / 100.0) - 180.0; //0 to 36000 for the absolute encoder
            // probably needs to be kept between -180 and 180 for consistency
            ...
            //might need to normalize these speeds***********************
